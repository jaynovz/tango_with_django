...
def get_category_list_suggest(max_results=0, starts_with=''):
        cat_list = []
        if starts_with:
...
def suggest_category(request):
        ...
        cat_list = get_category_list_suggest(8, starts_with)
...
def auto_add_page(request):
    ...
    if request.method == 'GET':
        ...
        if cat_id:
            ...
            context_dict['pages'] = pages
            context_dict['category'] = category
            context_dict['category_name_url'] = encode_url(category.name)
            print p
    return render_to_response('rango/category.html', context_dict, context)
